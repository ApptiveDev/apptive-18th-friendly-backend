...
public class PostServiceTest {
    ...
    public void 게시물_추가() {
        ...
        Assert.assertEquals(newPost, postRepository.findOneById(newPost.getId()));
    }
    
//    @Test
//    public void 게시물_리스트_조회() {
//        AccountPost accountPost = new AccountPost();
//        Post newPost = new Post(accountPost, "title", "description", 5, LocalDateTime.now(), "busan", "rule");
//
//        AccountPost accountPost2 = new AccountPost();
//        Post newPost2 = new Post(accountPost2, "title2", "description2", 3, LocalDateTime.now(), "usan", "rule2");
//        postService.save(newPost);
//        postService.save(newPost2);
//
